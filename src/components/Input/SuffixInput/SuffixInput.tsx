...
import classes from "./suffixinput.module.css"
import type { SuffixInputProps } from "./SuffixInput.types"
...
export const SuffixInput = ({
  ...
  return (
    <div className={wrapperClass} aria-disabled={forcedDisabled} onClick={handleWrapperClick}>
      <div className={[classes.control, effectiveError ? classes.error : ""].join(" ")} data-testid="suffixinput-control">
        <input
          ref={inputRef}
          id={id}
          name={name}
      ...
      <div className={classes.suffix} data-testid="suffixinput-suffix">{suffix}</div>
    </div>
  )
}
